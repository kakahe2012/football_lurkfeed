...
export function ContentLayout({ children, trending }: ContentLayoutProps) {
  return (
    <div className="mx-auto w-full max-w-7xl px-3 pt-4 md:px-6 lg:grid lg:grid-cols-[minmax(0,1fr)_22.5rem] lg:items-start lg:gap-6 xl:grid-cols-[minmax(0,1fr)_22.5rem] xl:gap-7">
